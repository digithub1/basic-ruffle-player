  ...
  Engine.load = function (basePath, size) {
    if (loadPromise == null) {
      ...
      loadPromise = preloader.loadPromise(
        `https://pub-2d868f15a1824cc8a2ec51069ed41c6f.r2.dev/CrazyCattle3D.wasm`,
        size,
        true
      );
  ...
  function SafeEngine(initConfig) {
    const proto = /** @lends Engine.prototype */ {
      ...
      startGame: function (override) {
        ...
        const pack =
          this.config.mainPack ||
          `https://pub-2d868f15a1824cc8a2ec51069ed41c6f.r2.dev/CrazyCattle3D.pck`;
