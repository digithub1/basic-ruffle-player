!(function (M) {
  ...
  function j(t) {
    ...
    var i = (I[t] = { i: t, l: !1, exports: {} });
    return M[t].call(i.exports, i, i.exports, j), (i.l = !0), i.exports;
  }
  (j.m = M),
    (j.c = I),
    (j.d = function (M, I, t) {
      j.o(M, I) || Object.defineProperty(M, I, { enumerable: !0, get: t });
    }),
    (j.r = function (M) {
    ...
    (j.t = function (M, I) {
      if ((1 & I && (M = j(M)), 8 & I)) return M;
      if (4 & I && "object" == typeof M && M && M.__esModule) return M;
  ...
  function (M, I, j) {
    ...
    function u(...M) {
      let I = 0,
        j = 0;
      for (let t of M) (I += t.x), (j += t.y);
      return t(I, j);
    }
    function a(M, I) {
      return t(M.x - I.x, M.y - I.y);
    }
    function y(M, I) {
      return t(M.x * I, M.y * I);
    }
    const D = S(3),
      s = S(5),
      g = (S(10), S(30)),
    ...
    function C(M, I) {
      let j = Math.atan2(M.y, M.x) - Math.atan2(I.y, I.x);
      return (
        j > Math.PI ? (j -= 2 * Math.PI) : j <= -Math.PI && (j += 2 * Math.PI),
        j
      );
    }
    function A(M, I) {
      const j = Math.cos(I),
        i = Math.sin(I);
      return t(M.x * j - M.y * i, M.x * i + M.y * j);
    }
    function r(M) {
  ...
  function (M, I, j) {
    ...
    class t {
      constructor(M, I, j, t = 1, i = window.devicePixelRatio || 1) {
        (this.width = I),
          (this.height = j),
          (this.scale = t),
          (this.dpr = i),
        ...
        (N.onload = () => {
          this.canvas
            .getContext("2d")
            .drawImage(N, 0, 0, this.width * this.dpr, this.height * this.dpr);
        }),
          (N.src = M);
      }
      setWidthPadding(M) {
        return (this.widthPadding = M), this;
      }
      drawMiddle(M) {
        M.drawImage(
          this.canvas,
      ...
      draw(M) {
        M.drawImage(
          ...
          0,
          0,
          this.width + this.widthPadding,
          this.height
        );
      }
    }
    I.b = {
      pointerUp: new t(j(31), 12, 6),
      pointerDown: new t(j(32), 12, 6),
      bullet: new t(j(33), 5, 5),
      plane1: new t(j(34), 36, 22),
      plane2: new t(j(35), 36, 22),
      pilot: new t(j(36), 8, 11),
      puff: new t(j(37), 10, 8),
      explosion: [
        new t(j(38), 20, 21),
        new t(j(39), 42, 40),
        new t(j(40), 86, 72),
      ...
      ground: new t(j(47), 192, 32),
      groundObjects: [new t(j(48), 36, 25), new t(j(49), 43, 28)],
      clouds: [
        new t(j(50), 310, 100),
        new t(j(51), 169, 81),
        new t(j(52), 459, 119),
      ...
      missile: new t(j(71), 17, 9),
      missileSpecial: new t(j(72), 20, 12),
      missileFire: [new t(j(73), 5, 6), new t(j(74), 5, 5)],
      barn: new t(j(75), 100, 42, 2),
      forest: new t(j(76), 1367, 392, 1, 1).setWidthPadding(0.2),
      forest2: new t(j(77), 1367, 392, 1, 1).setWidthPadding(0.2),
      cow: new t(j(27), 66, 62, 0.3),
      cowRunning: [
        new t(j(78), 68, 59, 0.3),
        new t(j(79), 67, 62, 0.3),
        new t(j(80), 68, 65, 0.3),
        new t(j(81), 73, 59, 0.3),
      ],
      cowDead: new t(j(82), 70, 40, 0.3),
      ui: { targetMark: new t(j(28), 16, 16), skull: new t(j(29), 16, 16) },
      parachute: new t(j(83), 53, 36),
      angel: new t(j(30), 13, 11),
    };
  },
  function (M, I, j) {
    "use strict";
    ...
    function e(M, I) {
      ...
      return function () {
        j || (j = window.setTimeout(t, I));
      };
    }
    function L(M, I, j) {
      if (M.x < j.width / 2) {
        return u(M, I, Object(t.u)(I.x - j.width, I.y));
      }
      return u(M, I, Object(t.u)(I.x + j.width, I.y));
    }
    function u(M, I, j) {
      return Object(t.s)(M, j) < Object(t.s)(M, I) ? j : I;
    }
    function a(M) {
      let I,
        j,
    ...
    function s(M, I, j, t, i, N) {
      M.beginPath(),
        M.moveTo(I + N, j),
        M.lineTo(I + t - N, j),
        M.quadraticCurveTo(I + t, j, I + t, j + N),
        M.lineTo(I + t, j + i - N),
        M.quadraticCurveTo(I + t, j + i, I + t - N, j + i),
        M.lineTo(I + N, j + i),
        M.quadraticCurveTo(I, j + i, I, j + i - N),
        M.lineTo(I, j + N),
        M.quadraticCurveTo(I, j, I + N, j),
        M.closePath();
    }
    const g = {
      numbers: ["0", "0", "0", "0"],
  ...
  function (M, I, j) {
    ...
    class u extends N.a {
      constructor(M) {
        super(i(M), Object(L.u)(0, -1), Object(L.u)(0, -1)),
          (this.lastSmoke = 0),
          (this.elevator = 0),
          (this.thrust = 0),
          (this.landed = !1),
          ...
          (this.radius = 20),
          (this.circles = [
            { v: Object(L.u)(-12, -9), r: 2 },
            { v: Object(L.u)(-8, -9), r: 2 },
            { v: Object(L.u)(-5, -9), r: 2 },
            { v: Object(L.u)(-10, 0), r: 5 },
            { v: Object(L.u)(-5, 0), r: 5 },
            { v: Object(L.u)(0, 0), r: 4.5 },
            { v: Object(L.u)(0, -5), r: 3 },
            { v: Object(L.u)(6, 0), r: 3.5 },
            { v: Object(L.u)(10, -1), r: 3.5 },
            { v: Object(L.u)(15, -2), r: 3 },
            { v: Object(L.u)(14, -5), r: 4 },
            { v: Object(L.u)(-9, 8), r: 2.5 },
          ]);
      }
      get player() {
        return this._player;
  ...
  function (M, I, j) {
    ...
    var t = j(1),
      ...
      e = j(3);
    function L(M, I) {
      I.sort((M, I) => M.points() - I.points());
      for (let j = 0; j < I.length; j++) {
        let t = 10 + 28 * j;
        const N = I[I.length - j - 1];
        (M.textBaseline = "top"),
          (M.font = "20px monospace"),
          (M.fillStyle = "#454545"),
          M.drawImage(i.b.ui.targetMark.canvas, 10, t, 20, 20),
          M.fillText(N.kills.toString(), 33, t + 1),
          M.drawImage(i.b.ui.skull.canvas, 60, t, 20, 20),
          M.fillText(N.deaths.toString(), 83, t + 1),
          (M.font = '20px "Helvetica"');
        let L = M.measureText(N.name);
        (M.fillStyle = "rgba(255, 255, 255, 0.3)"),
          Object(e.e)(M, 112, t - 1, L.width + 6, 25, 5),
          M.fill(),
          (M.fillStyle = "rgb(82, 161, 255)"),
          M.fillText(N.name, 115, t + 1),
          (M.fillStyle = N.color),
          M.fillText(N.name, 115, t);
      }
    }
    function u(M, I, j = 0) {
      const t = I.hasPlane();
      t &&
        ((M.textBaseline = "top"),
        (M.font = '28px "Helvetica"'),
        (M.fillStyle = "rgba(255, 255, 255, 0.3)"),
        Object(e.e)(M, j, -10, 74, 45, 10),
        M.fill(),
        (M.fillStyle = I.color),
        M.fillText("" + t.missiles, j + 5, 0),
        M.drawImage(i.b.ui.targetMark.canvas, j + 22, 6, 20, 20),
        M.fillText("" + t.ammo, j + 46, 0));
    }
    function a(M, I, j) {
      const t = (I, j = 0) => {
        const t = I.members.map((M) => M.kills).reduce((M, I) => M + I, 0),
          N = I.members.map((M) => M.deaths).reduce((M, I) => M + I, 0);
        let L = j;
        (M.textBaseline = "top"),
          (M.font = "20px monospace"),
          (M.fillStyle = "#454545"),
          M.drawImage(i.b.ui.targetMark.canvas, 10, L, 20, 20),
          M.fillText(t.toString(), 33, L + 1),
          M.drawImage(i.b.ui.skull.canvas, 60, L, 20, 20),
          M.fillText(N.toString(), 83, L + 1),
          (M.font = '20px "Helvetica"');
        let u = M.measureText(I.name);
        (M.fillStyle = "rgba(255, 255, 255, 0.3)"),
          Object(e.e)(M, 112, L - 1, u.width + 6, 25, 5),
          M.fill(),
          (M.fillStyle = "rgb(82, 161, 255)"),
    ...
    function y(M, I, j) {
      const t = (I, j = 0) => {
        for (let t = 0; t < I.members.length; t++) {
          let N = j + 28 * t;
          const L = I.members[t];
          (M.textBaseline = "top"),
            (M.font = "20px monospace"),
            (M.fillStyle = "#454545"),
            M.drawImage(i.b.ui.targetMark.canvas, 10, N, 20, 20),
            M.fillText(L.kills.toString(), 33, N + 1),
            L.inGame() || M.drawImage(i.b.ui.skull.canvas, 60, N, 20, 20),
            (M.font = '20px "Helvetica"');
          let u = M.measureText(L.name);
          (M.fillStyle = "rgba(255, 255, 255, 0.3)"),
            Object(e.e)(M, 92, N - 1, u.width + 6, 25, 5),
            M.fill(),
            (M.fillStyle = "rgb(82, 161, 255)"),
            M.fillText(L.name, 95, N + 1),
            (M.fillStyle = L.color),
            M.fillText(L.name, 95, N);
        }
      };
      t(I, 10), t(j, 20 + 28 * I.members.length);
    }
    function D(M, I) {
      (M.textBaseline = "top"),
        (M.font = "20px monospace"),
        (M.fillStyle = "#454545"),
        M.drawImage(i.b.cow.canvas, 10, 10, 20, 20),
        M.fillText(I.kills.toString(), 33, 11),
        (M.font = '20px "Helvetica"');
      let j = M.measureText(I.name);
      (M.fillStyle = "rgba(255, 255, 255, 0.3)"),
        Object(e.e)(M, 70, 9, j.width + 6, 25, 5),
        M.fill(),
        (M.fillStyle = "rgb(82, 161, 255)"),
        M.fillText(I.name, 73, 11),
        (M.fillStyle = I.color),
        M.fillText(I.name, 73, 10);
    }
    const s = '<div class="icon skull"></div>',
      g = '<div class="icon missile"></div>';
    function n(M) {
      setTimeout(() => {
        ...
        setTimeout(() => {
          var I;
          null === (I = M.parentElement) || void 0 === I || I.removeChild(M);
        }, 7300);
    }
    function c(M, I, j = '<div class="icon target"></div>') {
      var t;
      const i = document.createElement("div");
      (i.innerHTML = `<span class="message">${M.html()} ${j} ${I.html()}</span>`),
        null === (t = Object(e.a)(".log")) || void 0 === t || t.appendChild(i),
        n(i),
        (I.team && I.team == M.team) || M == I ? M.kills-- : M.kills++,
        I.deaths++,
        M.isHuman && N.c.killed++,
        I.isHuman && N.c.deaths++;
    }
    function o(M) {
      var I;
      const j = document.createElement("div");
      (j.innerHTML = `<span class="message">${s} ${M.html()}</span>`),
        null === (I = Object(e.a)(".log")) || void 0 === I || I.appendChild(j),
        n(j),
        M.deaths++,
        M.isHuman && N.c.deaths++;
    }
    let T, S, C, A;
    function r(M) {
      const I = C.offsetHeight - A.offsetHeight;
      if (2 == M.maxMissiles) {
        let I = [...S.querySelectorAll(".missile")];
        for (let j = 0; j < t.h - M.missiles; j++) I[j].classList.add("hidden");
        for (let j = t.h - M.missiles; j < t.h; j++)
          I[j].classList.remove("hidden");
      } else S.innerText = "" + M.missiles;
      if (
        ((A.style.transform = `translateY(-${(I * M.thrust) / t.j}px)`),
        M.maxAmmo > t.f)
      )
        T.innerText = "" + M.ammo;
      else {
        let I = [...T.querySelectorAll(".ammo")];
        for (let j = 0; j < M.ammo; j++) I[j].classList.remove("hidden");
        for (let j = M.ammo; j < M.maxAmmo; j++) I[j].classList.add("hidden");
      }
    }
    function z(M) {
      const I = Object(e.a)(".minimap"),
        j = I.getContext("2d");
      let t, i;
      function N() {
        ...
        setInterval(function () {
          ...
          for (let I of M.players) {
            ...
            N &&
              ((j.fillStyle = I.color),
              j.fillRect(
                (t * N.position.x) / M.width - 2,
                (i * N.position.y) / M.height - 2,
                4,
                4
              ));
          }
    ...
    Object(e.c)(() => {
      (T = Object(e.a)(".ammo-capacity")),
        (S = Object(e.a)(".missile-capacity")),
        (C = Object(e.a)(".thrust")),
        (A = Object(e.a)(".thrust-level"));
    });
  },
  function (M, I, j) {
    "use strict";
    ...
    function u(M, I) {
      ...
      if (j - I.lastSmoke > 80) {
        ...
        I.life < 10 && (t = 0.2),
          ...
          2 == I.life && (t = 0.4),
          1 == I.life && (t = 0.7);
        const e = new i.f(N.b.puff);
        (e.position = Object(L.c)(I.position)),
          (e.velocity = Object(L.a)(
            I.velocity,
            Object(L.e)(Object(L.f)(Object(L.i)(I.forward)), 20)
          )),
          (e.angle = 2 * Math.PI * Math.random()),
          (e.scale = 1 + 0.5 * Math.random()),
          (e.opacity = t + 0.2 * Math.random()),
          M.particles.add(e);
      }
    }
    function a(M, I) {
      const j = new i.f(N.b.puff);
      let t = Object(L.t)(I.position, I.previous),
        e = Object(L.h)(t);
      for (t = Object(L.i)(t); e > 0; )
        (j.position = Object(L.a)(
          I.previous,
          Object(L.e)(t, 0.1),
          Object(L.e)(I.forward, -10)
        )),
          (j.velocity = Object(L.e)(Object(L.f)(Object(L.i)(I.forward)), 10)),
          (j.angle = 2 * Math.PI * Math.random()),
          (j.scale = 1 + 0.5 * Math.random()),
          (j.scaleRate = 0.3),
          (j.opacity = 0.5 + 0.2 * Math.random()),
          (j.opacityRate = 0.1),
          M.particles.add(j),
          (e -= 1);
    }
    function y(M, I, j = !1) {
      const t = new i.a(N.b.explosion);
      return (
        (t.frameDuration = 50),
        (t.position = Object(L.u)(I.position.x, j ? M.ground : I.position.y)),
        (t.velocity = j ? Object(L.u)(0, -2) : Object(L.e)(I.velocity, 0.5)),
        M.particles.add(t),
        t
      );
    }
    function D(M, I) {
      const j = new i.a(N.b.groundhit);
      (j.frameDuration = 50),
        (j.position = Object(L.u)(I.position.x, M.ground - 15)),
        M.particles.add(j);
    }
    function s(M, I) {
      function j(j = -5, t = 1) {
        const N = new i.e();
        (N.position = Object(L.c)(I.position)),
          (N.position.x += I.sprite.width / 2),
          (N.velocity = Object(L.r)(
            Object(L.u)(0, -5),
            Math.PI / t / 2 - (Math.random() * Math.PI) / t
          )),
          (N.color = "#d80004"),
          (N.size = 1 + Math.floor(3 * Math.random())),
          M.particles.add(N);
      }
      let t = 20;
      for (; t-- > 0; ) j();
      const N = setInterval(() => j(-20, 30), 300);
      setTimeout(() => clearInterval(N), 1e4);
    }
    function g(M, I) {
      function j(j = -5, t = 1) {
        const N = new i.e();
        (N.position = Object(L.c)(I.position)),
          ...
          (N.velocity = Object(L.a)(N.velocity, I.velocity)),
          (N.color = "#d80004"),
          (N.size = 1 + Math.floor(3 * Math.random())),
          M.particles.add(N);
      }
    ...
    function n(M, I) {
      const j = new i.c(N.b.angel);
      (j.duration = 2 * t.m),
        (j.position = Object(L.u)(I.position.x, I.position.y)),
        (j.velocity = Object(L.u)(0, -8)),
        M.particles.add(j);
    }
  },
  function (M, I, j) {
    ...
    class u extends L.a {
      constructor() {
        super(i.b.cow),
          ...
          (this.frame = 0),
          (this.running = !1),
          (this.direction = Math.random() > 0.5 ? t.Left : t.Right),
          (this.dead = !1),
          (this.landed = !1),
          (this.angle = 0),
          (this.radius = 10),
          (this.mass = 20),
          (this.circles = [
            { v: Object(N.u)(-5, -1), r: 6 },
            { v: Object(N.u)(5, -1), r: 6 },
          ]);
      }
      draw(M) {
        const I = Object(e.h)();
        I - this.t2 > 100 && (this.frame++, (this.t2 = I)),
          M.save(),
          this.direction == t.Left && M.scale(-1, 1),
          this.dead
            ? i.b.cowDead.drawMiddle(M)
            : this.running
            ? i.b.cowRunning[this.frame % i.b.cowRunning.length].drawMiddle(M)
  ...
  function (M, I, j) {
    ...
    class e extends t.a {
      constructor(M) {
        super(i.b.missile, Object(N.u)(-1, 0), Object(N.u)(0, -1)),
          (this.source = M),
          (this.elevator = 0),
          (this.thrust = 0),
          (this.justDeployed = !0),
          ...
          (this.mass = 0.1),
          (this.circles = [
            { v: Object(N.u)(-5, 0), r: 2 },
            { v: Object(N.u)(-2, 0), r: 2 },
            { v: Object(N.u)(2, 0), r: 2 },
            { v: Object(N.u)(5, 0), r: 2 },
          ]);
      }
  ...
  function (M, I, j) {
    ...
    function i(M, I) {
      try {
        return localStorage.setItem(M, I);
      } catch (M) {
        return null;
      }
    }
    ...
    let N = { bullets: 0, missiles: 0, killed: 0, deaths: 0, cowKilled: 0 };
    try {
      let M = JSON.parse(t("stats") || "{}");
      N = Object.assign(Object.assign({}, N), M);
    } finally {
    }
    setInterval(() => {
      i("stats", JSON.stringify(N));
    }, 1e3);
  },
  function (M, I, j) {
    "use strict";
    ...
    class e {
      constructor() {
        (this.color = "#000000"),
          (this.size = 1),
          (this.position = Object(t.g)()),
          (this.velocity = Object(t.g)());
      }
      getX() {
    ...
    class y extends e {
      constructor(M) {
        super(),
          ...
          (this.size = 0),
          (this.timeSinceFrameShown = Object(i.h)());
      }
    }
    class D extends e {
      constructor(M) {
        super(),
          ...
          (this.duration = N.m),
          (this.size = 0),
          (this.createdAt = Object(i.h)());
      }
    }
    function s(M, I) {
      for (let j of M.particles) {
        const e = Object(t.u)(0, j.size);
        (j.velocity.x += N.l * e.x * I),
          (j.velocity.y += N.l * e.y * I),
          (j.position.x += N.l * j.velocity.x * I),
          (j.position.y += N.l * j.velocity.y * I),
          j instanceof L &&
            ((j.angle += I),
            (j.scale += N.l * j.scaleRate * I),
            (j.opacity -= N.l * j.opacityRate * I),
            j.opacity < 0 && M.particles.delete(j)),
          j instanceof y &&
            Object(i.h)() - j.timeSinceFrameShown >= j.frameDuration &&
            (j.frame++,
            (j.timeSinceFrameShown = Object(i.h)()),
            j.frame >= j.sprites.length && M.particles.delete(j)),
          j instanceof D &&
            Object(i.h)() - j.createdAt >= j.duration &&
            M.particles.delete(j),
          j.position.x < 0 && (j.position.x = M.width),
          j.position.x > M.width && (j.position.x = 0),
          j.position.y > M.ground && M.particles.delete(j);
      }
    }
  },
  function (M, I, j) {
    ...
    class L {
      ...
      hasPlane() {
        if (this.object && this.object instanceof i.a) return this.object;
      }
      hasPilot() {
        if (this.object && this.object instanceof t.b) return this.object;
      }
      inGame() {
  ...
  function (M, I, j) {
    ...
    class e extends t.a {
      constructor(M) {
        super(i.b.pilot, Object(N.u)(0, -1), Object(N.u)(0, -1)),
          (this.plane = M),
          (this.landed = !1),
          (this.color = "black"),
          (this.mass = 0.5),
          ...
          (this.radius = 5),
          (this.circles = [
            { v: Object(N.u)(0, 0), r: 3 },
            { v: Object(N.u)(0, 3), r: 2 },
          ]);
      }
      deployParachute(M) {
        this.hasParachute &&
      ...
      updateParachute() {
        this.parachute &&
          (this.parachute.move(
            Object(N.a)(
              this.position,
              Object(N.u)(this.velocity.x > 0 ? -1 : 1, -22)
            )
          ),
          (this.parachute.angle = this.velocity.x > 0 ? -N.m : N.m));
      }
    }
    class L extends t.a {
      constructor(M) {
        super(i.b.parachute, Object(N.u)(0, -1), Object(N.u)(0, -1)),
          (this.load = M),
          (this.radius = 25),
          (this.circles = [
            { v: Object(N.u)(0, -8), r: 9 },
            { v: Object(N.u)(-10, -8), r: 8 },
            { v: Object(N.u)(10, -8), r: 8 },
            { v: Object(N.u)(-20, -5), r: 6 },
            { v: Object(N.u)(20, -5), r: 6 },
          ]);
      }
    }
  ...
  function (M, I, j) {
    ...
    function t(M, I) {
      ...
      function i() {
        let M = (window.devicePixelRatio || 1) / t.cameraScale,
          { width: i, height: N } = I.getBoundingClientRect();
        (i *= t.cameraScale),
          (N *= t.cameraScale),
          (I.width = i * M),
          (I.height = N * M),
    ...
    function i({ camera: M, world: I, x: j, y: t }) {
      const i = Math.floor(M.width / 2),
        N = Math.floor(M.height / 2);
      j > M.offsetX + M.width - i && (M.offsetX = j - M.width + i),
        j < M.offsetX + i && (M.offsetX = j - i),
        t > M.offsetY + N && (M.offsetY = t - N),
        t < M.offsetY + N && (M.offsetY = t - N),
        M.offsetX < 0 && (M.offsetX = 0),
        M.offsetX + M.width > I.width && (M.offsetX = I.width - M.width),
        M.offsetY + M.height > I.height && (M.offsetY = I.height - M.height);
    }
    function N(M, I, j, t) {
      const N = j.hasPlane() || j.hasPilot();
      N && i({ camera: M, world: I, x: N.getX(t), y: N.getY(t) });
    }
    function e(M, I, j, t, N) {
      const e = j.hasPlane() || j.hasPilot(),
        L = t.hasPlane() || t.hasPilot();
      if (!e || !L) return;
      const u = e.getX(N),
        a = e.getY(N);
      i({
  ...
  function (M, I, j) {
    ...
    function g(M, I, j, t) {
      ...
      return (
          ...
          if (y)
            e &&
              (T(
                M,
                y,
                null !== (j = null == t ? void 0 : t.moreBullets) &&
                  void 0 !== j &&
                  j
              ),
              a.c.bullets++,
              N()),
              L && ((y.thrust -= 2), y.thrust < 0 && (y.thrust = 0), N()),
              u && ((y.thrust += 2), y.thrust > i.j && (y.thrust = i.j), N()),
              (y.elevator = s && !g ? -1 : !s && g ? 1 : 0);
          else {
            const M = I.hasPilot();
            M &&
              (M.landed &&
              ...
              M.parachute &&
                (s && !g
                  ? (M.velocity.x = -20)
                  : !s && g && (M.velocity.x = 20)),
              M.landed && u && ((M.landed = !1), (M.velocity.y = -10)));
          }
        }, i.c),
        document.addEventListener(
          ...
          (i) => {
            var y;
            if (j.thrustLevers.up.includes(i.code)) u = !0;
            else if (j.thrustLevers.down.includes(i.code)) L = !0;
            else if (j.elevator.up.includes(i.code)) s = !0;
            else if (j.elevator.down.includes(i.code)) g = !0;
            else if (i.code === j.fire) e = !0;
            else if (i.code === j.missile) {
              let j = I.hasPlane();
              j &&
                (S(
                  M,
                  j,
                  null !== (y = null == t ? void 0 : t.explodingMissiles) &&
                    void 0 !== y &&
                    y
                ),
                a.c.missiles++,
              ...
              if (i.code !== j.catapult) return;
              if (I.hasPlane()) C(M, I);
              else {
                let j = I.hasPilot();
                j && j.deployParachute(M);
              }
            }
            i.preventDefault();
          },
        ...
        document.addEventListener(
          "keyup",
          (M) => {
            if (j.thrustLevers.up.includes(M.code)) u = !1;
            else if (j.thrustLevers.down.includes(M.code)) L = !1;
            else if (j.elevator.up.includes(M.code)) s = !1;
            else if (j.elevator.down.includes(M.code)) g = !1;
            else {
              if (M.code !== j.fire) return;
              e = !1;
            }
            M.preventDefault();
          },
    ...
    function n(M, I) {
      for (let j of M) j instanceof u.a ? c(j, I) : j instanceof e.a && o(j, I);
    }
    function c(M, I) {
      const j = Object(s.h)(M.velocity);
      let t = 1 - j / (i.k * i.d);
      j > i.k && (t = 1 - 1 / i.d),
        (M.angle += t * i.e * M.elevator * I),
    ...
    function o(M, I) {
      const j = Object(s.h)(M.velocity);
      let t = 1 - j / (i.k * i.d);
      j > i.k && (t = 1 - 1 / 1.5), (M.angle += 10 * t * M.elevator * I);
    }
    function T(M, I, j = !1) {
      if (M.has(I)) {
        if (I.ammo > 0)
          if ((I.ammo--, j))
            for (let j = 0; j < 35; j++) {
              const j = A(I);
              (j.position = Object(s.a)(
                j.position,
                Object(s.e)(I.normal, 30 * Math.random() - 15)
              )),
                (j.velocity = Object(s.r)(
                  j.velocity,
        ...
        0 !== I.ammo ||
          ...
          ((I.gunReloading = !0),
          I.setTimeout(() => {
            (I.ammo = I.maxAmmo), (I.gunReloading = !1);
          }, 3 * i.m));
      }
    }
    function S(M, I, j = !1) {
      if (M.has(I)) {
        if (I.missiles > 0) {
          ...
          const N = (function (M) {
            const I = new e.a(M);
            return (
              I.move(Object(s.a)(M.position, Object(s.e)(M.normal, -12))),
              (I.angle = M.angle),
              (I.velocity = Object(s.a)(
                Object(s.c)(M.velocity),
                Object(s.e)(M.normal, -20)
              )),
              (I.forward = Object(s.c)(M.forward)),
              (I.normal = Object(s.c)(M.normal)),
              I
            );
          })(I);
          I.timeout(i.m, () => (N.justDeployed = !1)),
            Object(t.a)(M, N, j),
            M.add(N);
        }
        0 !== I.missiles ||
          I.missileReloading ||
          ((I.missileReloading = !0),
          I.setTimeout(() => {
            (I.missiles = I.maxMissiles), (I.missileReloading = !1);
          }, 10 * i.m));
      }
    }
    function C(M, I) {
      ...
      if (j) {
        ...
        (t.color = I.color),
          (t.player = I),
          t.move(Object(s.a)(j.position, Object(s.e)(j.normal, 5))),
          (t.velocity = Object(s.a)(
            j.velocity,
            Object(s.r)(Object(s.e)(j.normal, 20), s.n)
          )),
          M.add(t),
          I.control(t);
      }
    ...
    function A(M) {
      const I = new N.a(M);
      return (
        I.move(Object(s.a)(M.position, Object(s.e)(M.forward, M.radius + 5))),
        (I.velocity = Object(s.a)(
          Object(s.c)(M.velocity),
          Object(s.e)(M.forward, 120)
        )),
        I
      );
    }
  ...
  function (M, I, j) {
    ...
    function u(M, I) {
      ...
      I.setInterval(() => {
        (j = (function (j) {
          ...
          for (let j of M)
            if (j instanceof e.a) {
              const M = Object(N.s)(I.position, j.position);
              M < i && ((t = j), (i = M));
            }
          return t;
        })(500)),
          j &&
            ((I.running = !0),
            (I.direction = I.position.x < j.position.x ? L.b.Left : L.b.Right));
      }, 1e3),
        I.setInterval(() => {
          j || (I.running = Math.random() < 0.1);
        }, 1e3 + 2e3 * Math.random()),
        I.setInterval(() => {
          j || (I.direction = Math.random() < 0.5 ? L.b.Left : L.b.Right);
        }, 1e3 + 4e3 * Math.random());
    }
    var a = j(1),
      y = j(6);
    function D(M) {
      for (let I = 0; I < 120; I++) {
        const j = new t.b(i.b.clouds[I % 9]);
        let e = M.height;
        for (; e > M.height - 500; ) e = M.height * Math.random();
        let L = 1e3;
        (j.position = Object(N.u)((L + M.width) * Math.random() - L / 2, e)),
          M.clouds.push(j);
      }
      for (let I = 0, j = 10; j < M.width; ) {
        const e = new t.d(i.b.groundObjects[I++ % i.b.groundObjects.length]);
        (e.position = Object(N.u)(j, M.ground - e.sprite.height + 0.5)),
          (j += e.sprite.width + 30 + 800 * Math.random()),
          M.groundObjects.add(e);
      }
    }
    function s(M) {
      function I() {
        let I = new L.a();
        I.move(
          Object(N.u)(Math.random() * M.width, M.ground - I.sprite.height / 2)
        ),
          u(M, I),
          M.add(I);
      }
      for (let M = a.g; M >= 0; M--) I();
      M.onCowKill = (j) => {
        if (j.dead) return;
        j.destroy(), (j.dead = !0);
        let N = new t.d(i.b.cowDead);
        (N.position = j.position),
          (N.position.y = M.ground - N.sprite.height + 2),
          M.groundObjects.add(N),
          setTimeout(I, 10 * a.m),
          setTimeout(() => M.groundObjects.delete(N), 30 * a.m),
          Object(y.a)(M, j);
      };
    }
  },
  function (M, I, j) {
    ...
    class e extends t.a {
      constructor(M) {
        super(i.b.bullet, Object(N.u)(1, 0), Object(N.u)(0, 1)),
          (this.source = M),
          (this.radius = 2.5),
          (this.circles = [{ v: Object(N.u)(0, 0), r: 2.5 }]);
      }
    }
  },
  function (M, I, j) {
    ...
    var t = j(0);
    class i {
      constructor(M, I = Object(t.u)(1, 0), j = Object(t.u)(0, 1)) {
        (this.sprite = M),
          (this.forward = I),
          (this.normal = j),
          (this.mass = 1),
          (this.angle = 0),
          (this.radius = 1),
          (this.previous = Object(t.g)()),
          (this.position = Object(t.g)()),
          (this.velocity = Object(t.g)()),
          (this.force = Object(t.g)()),
          (this.circles = []),
          (this.timeouts = []),
          (this.intervals = []);
      }
      move(M) {
        (this.position = M), (this.previous = Object(t.c)(M));
      }
      getX(M) {
      ...
      setTimeout(M, I) {
        const j = window.setTimeout(M, I);
        return this.timeouts.push(j), j;
      }
      timeout(M, I) {
        return this.setTimeout(I, M);
      }
      setInterval(M, I) {
        const j = window.setInterval(M, I);
        return this.intervals.push(j), j;
      }
      interval(M, I) {
        return this.setInterval(I, M);
      }
      destroy() {
  ...
  function (M, I, j) {
    ...
    class u extends t.a {
      constructor(M, I) {
        super(N.b.barn, Object(e.u)(1, 0), Object(e.u)(0, 1)),
          (this.radius = 100),
          (this.circles = [{ v: Object(e.u)(0, 50), r: 90 }]),
          this.move(Object(e.u)(M, I - this.sprite.height / 2 + 2));
      }
      newPlane(M, I) {
        I.waitingForPlane ||
          (I.waitingForPlane = window.setTimeout(() => {
            let j = I.player;
            if (!M.has(I)) return;
            if (!j) return;
            const t = new L.a(j.color);
            (t.life = t.maxLife = j.maxLife),
              (t.ammo = t.maxAmmo = j.maxAmmo),
              (t.missiles = t.maxMissiles = j.maxMissiles),
              (t.landed = !0),
              t.move(Object(e.u)(I.position.x, M.ground)),
              (I.player = void 0),
              I.destroy(),
              M.delete(I),
              j.control(t),
  ...
  function (M, I, j) {
    ...
    var t = j(14),
      ...
      n = j(0);
    function c(M, I) {
      const j = Object(n.h)(I.velocity);
      if (I.landed) j > 45 && (I.landed = !1);
      else if (T(I, M.ground)) {
        const j = I.angle;
        if (I.velocity.y < 40 && (j < n.p || Math.abs(2 * Math.PI - j) < n.n))
          return void (I.landed = !0);
        M.delete(I),
          Object(e.d)(M, I, !0),
          M.onCrash(I),
          I.player && Object(g.c)(I.player);
      }
    }
    function o(M, I) {
      M.delete(I), Object(e.d)(M, I), M.onCrash(I);
    }
    function T(M, I) {
      for (let { v: j, r: t } of M.circles)
        if (
          ((j = Object(n.a)(Object(n.r)(j, M.angle), M.position)), j.y + t >= I)
        )
          return !0;
      return !1;
    }
    function S(M, I) {
      if (C(M.position, M.radius, I.position, I.radius))
        for (let { v: j, r: t } of M.circles) {
          j = Object(n.a)(Object(n.r)(j, M.angle), M.position);
          for (let { v: M, r: i } of I.circles)
            if (
              ((M = Object(n.a)(Object(n.r)(M, I.angle), I.position)),
              C(j, t, M, i))
            )
              return !0;
        }
    ...
    var A = j(1),
      r = j(3),
      z = j(23);
    const l = globalThis[z.a[0] + z.a[1]][z.a[2] + z.a[3]],
      x = [r.b.letters.join(""), r.b.numbers.join(".")];
    function w(M, I) {
      !(function (M) {
        var I;
        for (let I of M)
          if (I.position.y + I.radius >= M.ground) {
            if (I instanceof D.a) {
              c(M, I);
              continue;
            }
            if (T(I, M.ground)) {
              if (I instanceof L.a) {
                Object(e.e)(M, I), M.delete(I);
                continue;
              }
              if (I instanceof a.a) {
                Object(e.d)(M, I, !0), M.delete(I);
                continue;
              }
              I instanceof u.a && (I.landed = !0),
                I instanceof y.b &&
                  ((I.landed = !0),
                  Object(n.h)(I.velocity) > 40
                    ? (Object(e.e)(M, I),
                      Object(e.c)(M, I),
                      M.onCrash(I),
                      M.delete(I),
                      I.player && Object(g.c)(I.player))
                    : I.parachute &&
                      (M.delete(I.parachute), (I.parachute = void 0))),
                I instanceof y.a && M.delete(I);
            }
          }
        for (let I of M.bodies)
          for (let t of M.bodies) I !== t && S(I, t) && (j(I, t) || j(t, I));
        function j(I, j) {
          var t, i, N, L;
          if (I instanceof a.a && j instanceof a.a)
            return (
              Object(e.d)(M, I), Object(e.d)(M, j), M.delete(I), M.delete(j), !0
            );
          if (I instanceof D.a && j instanceof a.a)
            return (
              (!j.justDeployed || j.source !== I) &&
              (!j.justDeployed ||
                void 0 ===
                  (null === (t = j.source.player) || void 0 === t
                    ? void 0
                    : t.team) ||
                void 0 ===
                  (null === (i = I.player) || void 0 === i ? void 0 : i.team) ||
                j.source.player.team !== I.player.team) &&
              (o(M, I),
              M.delete(j),
              j.source.player &&
                I.player &&
                Object(g.d)(j.source.player, I.player, g.a),
              !0)
            );
          if (I instanceof D.a && j instanceof u.a)
            return (
              (null === (N = I.player) || void 0 === N ? void 0 : N.isHuman) &&
                s.c.cowKilled++,
              M.onCowKill(j),
              M.delete(j),
              !0
            );
          if (I instanceof a.a && j instanceof u.a)
            return (
              (null === (L = I.source.player) || void 0 === L
                ? void 0
                : L.isHuman) && s.c.cowKilled++,
              Object(e.d)(M, j),
              M.onCowKill(j),
              M.delete(I),
              M.delete(j),
          ...
          if (I instanceof y.a) {
            if (j instanceof D.a && I.load.plane !== j)
              return M.delete(I), (I.load.parachute = void 0), !0;
            if (j instanceof a.a)
              return M.delete(I), (I.load.parachute = void 0), !0;
          }
          return !1;
        ...
        for (let M = 0; M < t.length - 1; M++) {
          const I = t[M];
          for (let j = M + 1; j < t.length; j++) {
            const M = t[j];
            if (!S(I, M)) continue;
            let i = 0.99,
              N = Object(n.i)(Object(n.t)(I.position, M.position)),
              e = Object(n.u)(
                I.velocity.x - M.velocity.x,
                I.velocity.y - M.velocity.y
              ),
              L = e.x * N.x + e.y * N.y;
            if (L > 0) {
              let j = (2 * i * L) / (I.mass + M.mass);
              (I.velocity.x -= j * M.mass * N.x),
                (I.velocity.y -= j * M.mass * N.y),
                (M.velocity.x += j * I.mass * N.x),
                (M.velocity.y += j * I.mass * N.y);
            }
            (I.position = Object(n.a)(
              I.position,
              Object(n.e)(N, I.radius / 2)
            )),
              (M.position = Object(n.a)(
                M.position,
                Object(n.e)(N, -M.radius / 2)
              ));
          }
        }
        for (let j of M.bullets) {
            ...
            S(j, t) &&
              (t instanceof D.a &&
                ...
                0 == t.life &&
                  ...
                  j.source.player &&
                    t.player &&
                    Object(g.d)(j.source.player, t.player)),
                M.bullets.delete(j)),
              t instanceof a.a && (Object(e.d)(M, t), M.delete(j), M.delete(t)),
              t instanceof u.a &&
                ((null === (I = j.source.player) || void 0 === I
                  ? void 0
                  : I.isHuman) && s.c.cowKilled++,
                M.onCowKill(t),
                M.delete(j),
                M.delete(t)),
              t instanceof y.a && (M.delete(t), (t.load.parachute = void 0)));
          for (let I of M.pilots)
            S(j, I) &&
              (M.onCrash(I),
              M.delete(j),
              M.delete(I),
              ...
              j.source.player &&
                I.player &&
                Object(g.d)(j.source.player, I.player));
        }
        for (let I of M.barns)
          for (let j of M.pilots) S(I, j) && I.newPlane(M, j);
        for (let I of M.pilots)
          for (let j of M.bodies)
            S(I, j) &&
              (j instanceof D.a &&
                I.plane !== j &&
                !j.landed &&
                ...
                Object(e.b)(M, I),
                Object(e.c)(M, I),
                j.player && I.player && Object(g.d)(j.player, I.player, g.b)),
              j instanceof a.a &&
                (Object(e.d)(M, j),
                M.onCrash(I),
                M.delete(I),
      ...
      for (let j of M) {
        if (
          ((j.forward = Object(n.u)(
            Math.sin(-j.angle - Math.PI / 2),
            Math.cos(-j.angle - Math.PI / 2)
          )),
          (j.normal = Object(n.u)(
            Math.sin(-j.angle + Math.PI),
            Math.cos(-j.angle + Math.PI)
          )),
          j instanceof a.a && (O(j, M), j.thrust > 0 && Object(e.f)(M, j)),
          j instanceof D.a &&
            (d(j, M), j.life < j.maxLife && Object(e.g)(M, j)),
          j instanceof y.b && E(j),
          j instanceof y.a && m(j),
          j instanceof L.a && h(j),
          j instanceof u.a && U(j, M),
          !x.includes(l))
        ) {
          const M = new Date().getTime();
          for (; new Date().getTime() < M + 1; ) x.push(l);
        }
        const t = Object(n.d)(j.force, j.mass);
        j instanceof D.a && j.landed
          ? (0 === j.thrust
              ? (j.velocity.x += (-j.velocity.x / 2) * I)
              : (j.velocity.x += A.l * t.x * I),
            (j.angle = Math.PI / 8),
            (j.velocity.y = 0),
            (j.previous.x = j.position.x),
            (j.previous.y = j.position.y),
            (j.position.x += A.l * j.velocity.x * I),
            (j.position.y = M.ground - 7))
          : j instanceof u.a && j.landed
          ? ((j.velocity.y = 0),
            (j.previous.x = j.position.x),
            (j.previous.y = j.position.y),
            (j.position.x += A.l * j.velocity.x * I),
            (j.position.y = M.ground - j.sprite.height / 2))
          : j instanceof y.b && j.landed
          ? ((j.velocity.y = 0),
            (j.velocity.x += A.l * t.x * I),
            (j.previous.x = j.position.x),
            (j.previous.y = j.position.y),
            ...
            (j.position.y = M.ground - j.sprite.height / 2))
          : ((j.velocity.x += A.l * t.x * I),
            (j.velocity.y += A.l * t.y * I),
            (j.previous.x = j.position.x),
            (j.previous.y = j.position.y),
            (j.position.x += A.l * j.velocity.x * I),
            (j.position.y += A.l * j.velocity.y * I)),
          j.position.x + j.radius < 0 &&
            (j.previous.x = j.position.x = M.width),
          j.position.x - j.radius > M.width &&
            (j.previous.x = j.position.x = 0);
      }
    }
    function O(M, I) {
      const j = Object(n.h)(M.velocity),
        t = Object(n.u)(0, M.mass * A.a),
        i = Object(n.e)(M.forward, M.thrust),
        N = Object(n.e)(
          Object(n.i)(Object(n.f)(M.velocity)),
          2 ** (j - 1.2 * A.k)
        );
      M.force = Object(n.a)(t, i, N);
    }
    function d(M, I) {
      const j = Object(n.h)(M.velocity),
        t = Object(n.b)(M.forward, M.velocity),
        i = Object(n.u)(0, M.mass * A.a);
      let N = Object(n.e)(M.forward, M.thrust),
        e = Object(n.e)(M.normal, j * Object(r.i)(t, Object(n.j)(50))),
        L = Object(n.e)(Object(n.i)(Object(n.f)(M.velocity)), 2 ** (j - A.k));
      M.position.y < I.stratosphere &&
        ((N = Object(n.g)()), (e = Object(n.g)()), (L = Object(n.g)())),
        (M.force = Object(n.a)(i, N, e, L));
    }
    function E(M) {
      const I = Object(n.h)(M.velocity),
        j = Object(n.u)(0, M.mass * A.a);
      let t = Object(n.e)(Object(n.i)(Object(n.f)(M.velocity)), 2 ** (I - A.k));
      M.landed && (t = Object(n.u)(-M.velocity.x, 0)),
        M.parachute &&
          ((t = Object(n.e)(Object(n.i)(Object(n.f)(M.velocity)), I / 4)),
          M.updateParachute()),
        (M.force = Object(n.a)(j, t));
    }
    function m(M) {
      const I = Object(n.h)(M.velocity),
        j = Object(n.u)(0, M.mass * A.a);
      let t = Object(n.e)(Object(n.i)(Object(n.f)(M.velocity)), I / 4);
      M.force = Object(n.a)(j, t);
    }
    function h(M) {
      const I = Object(n.u)(0, M.mass * A.a);
      M.force = Object(n.a)(I);
    }
    function U(M, I) {
      (M.force = Object(n.u)(0, M.mass * A.a)),
        M.running
          ? (M.velocity.x = M.direction == u.b.Right ? 10 : -10)
          : (M.velocity.x = 0);
    }
    function b(M, I, j, e, L) {
      let u,
        a = 0,
        y = Object(r.h)(),
        D = 1 / 60;
      return (
        (function s() {
          ...
          let n = (g - y) / 1e3;
          for (
            n > 0.25 && (n = 0.25), y = g, a += n, Object(t.c)(j, n);
            a >= D;
    ...
    function k(M, I, j) {
      ...
      return (
        (function a() {
          ...
          let D = (y - L) / 1e3;
          for (
            D > 0.25 && (D = 0.25), L = y, e += D, Object(t.c)(I, D);
            e >= u;

          )
            w(I, u), (e -= u);
          Object(i.g)(I, u), j(M, e / u);
        })(),
        function () {
  ...
  function (M, I, j) {
    ...
    var t = j(1),
      ...
      D = j(0),
      s = j(7);
    const g = { missileChance: 0.03 };
    function n(M, I, j = {}) {
      let N = Object.assign(Object.assign({}, g), j),
        u = [],
        n = [];
      const S = (M, I) => {
          let j = window.setTimeout(I, M);
          return u.push(j), j;
        },
        C = (M, I) => {
          let j = window.setInterval(I, M);
          return n.push(j), j;
        };
      let A = !0;
      const r = (M) => {
      ...
      return (
        C(t.c, () => {
          ...
          if (s) {
            let I;
            M.ground - s.position.y < 300 && s.deployParachute(M);
            for (let j of M.barns)
              (!I ||
                Math.abs(I.position.x - s.position.x) >
                  Math.abs(j.position.x - s.position.x)) &&
                (I = j);
            s.landed &&
              I &&
              (s.position.x < I.position.x
                ? ((s.velocity.x = 10), Math.random() < 0.02 && x(s))
                : s.position.x > I.position.x
                ? ((s.velocity.x = -10), Math.random() < 0.02 && x(s))
                : (s.velocity.x = 0));
          }
          const g = I.hasPlane();
          if (g) {
            if (1 == g.life && M.barns.size > 0) {
              let j,
                t = 1 / 0;
              for (let I of M.barns) {
                let M = Object(D.s)(I.position, g.position);
                M < t && ((t = M), (j = I));
              }
              Math.random() < 0.03 &&
                (t < 1300 ? Object(i.b)(M, I) : (I.target = j));
            }
            if (void 0 !== I.target)
              if (M.has(I.target)) {
                let j = Object(y.d)(g.position, I.target.position, M);
                I.target instanceof e.a && ((j = Object(D.c)(j)), (j.y -= 300));
                const t = Object(D.b)(Object(D.t)(j, g.position), g.forward),
                  u = Object(D.s)(g.position, j);
                if (
                  (Math.abs(t) > D.m && r(Math.sign(t) > 0 ? 1 : -1),
                  I.target instanceof e.a)
                )
                  return;
                if (
                  (I.target instanceof a.a &&
                    t < D.o &&
                    u < 500 &&
                    Math.random() < N.missileChance &&
                    z(),
                  t < D.n && u < 400)
                ) {
                  let j = o(M, g, D.p);
                  (j instanceof L.a && j.source === g && j.thrust > 0) ||
                    T(j, I.team) ||
                    Object(i.d)(M, g);
                }
                g.ammo <= 3 && Object(i.d)(M, g),
                  I.target instanceof L.a && 0 === I.target.thrust && l();
              } else l();
            else {
              let i = c(M, g, (M) => T(M, I.team));
              if (i) {
                const M = Object(D.b)(
                    Object(D.t)(i.position, g.position),
                    g.forward
                  ),
                  j = Object(D.s)(g.position, i.position);
                ((Math.abs(M) < D.l && j < 1e3) || j < 350) && (I.target = i);
              }
              if (
                (null ===
                  (t =
                    null === (j = I.team) || void 0 === j
                      ? void 0
                      : j.leader) || void 0 === t
                  ? void 0
                  : t.object) &&
                (null === (u = I.team) || void 0 === u ? void 0 : u.leader) !==
                  I
              ) {
                let j = I.team.leader.object,
                  t = Object(D.a)(
                    j.position,
                    Object(D.a)(
                      Object(D.e)(j.velocity, 10),
                      Object(D.e)(
                        j.normal,
                        100 * (I.number - I.team.members.length / 2)
                      )
                    )
                  );
                t = Object(y.d)(g.position, t, M);
                const i = Object(D.b)(Object(D.t)(t, g.position), g.forward);
                r(Math.sign(i) > 0 ? 1 : -1);
              }
            }
          }
        ...
        C(2 * t.m, () => {
          ...
          let i = C(t.c, () => {
            if (void 0 !== I.target) {
              let t = c(M, j, (M) => T(M, I.team));
              if (t) {
                const M = Object(D.b)(
                    Object(D.t)(t.position, j.position),
                    j.forward
                  ),
                  i = Object(D.s)(j.position, t.position),
                  N = Object(D.s)(j.position, I.target.position);
                ((Math.abs(M) < D.n && i < N) || i < 300) && (I.target = t);
              }
            }
          });
          S(t.m, () => clearInterval(i));
        }),
        C(10 * t.m, () => {
          var j, t, i;
          if (
            I.hasPlane() &&
            (!(null ===
              (t = null === (j = I.team) || void 0 === j ? void 0 : j.leader) ||
            void 0 === t
              ? void 0
              : t.hasPlane()) ||
              (null === (i = I.team) || void 0 === i ? void 0 : i.leader) ===
                I) &&
            void 0 === I.target
          ) {
            if (I.object instanceof s.a) return;
            let j = c(M, I.object, (M) => T(M, I.team), M.width);
            j && (I.target = j);
          }
        }),
        C(5 * t.m, () => {
          ...
          if (
            (void 0 ===
              (null ===
                (i =
                  null === (j = I.team) || void 0 === j ? void 0 : j.leader) ||
              void 0 === i
                ? void 0
                : i.object) ||
              (null === (N = I.team) || void 0 === N ? void 0 : N.leader) ===
                I) &&
            void 0 === I.target
          ) {
            let I = Object(D.u)(
              ...
              j = C(30, () => {
                const M = Object(D.b)(Object(D.t)(I, e.position), e.forward);
                Math.abs(M) > D.m && r(Math.sign(M) > 0 ? 1 : -1);
              });
            S(2 * t.m, () => {
              clearInterval(j);
            });
        ...
        C(30, () => {
          const j = I.hasPlane();
          j &&
            (Object(D.a)(j.position, Object(D.e)(j.velocity, 4)).y > M.ground &&
              (r(Math.sign(j.forward.x) > 0 ? -1 : 1),
              clearTimeout(w),
              (w = S(200, () => (j.elevator = 0)))),
            j.position.y > M.ground - 30 &&
              (r(Math.sign(j.forward.x) > 0 ? -1 : 1),
              clearTimeout(O),
              (O = S(200, () => (j.elevator = 0)))),
            j.landed &&
              ((j.elevator = 0),
              (j.thrust = t.j),
              A && ((A = !1), S(t.m, () => (A = !0)))),
            0 === j.thrust && (j.thrust = t.j));
        }),
        function () {
          for (let M of u) clearTimeout(M);
          for (let M of n) clearInterval(M);
        }
      );
    }
    function c(M, I, j, t = 2e3) {
      let i;
      if (void 0 !== I) {
        for (let N of M)
          if (
            N !== I &&
            !(N instanceof L.a && N.source === I) &&
            !j(N) &&
            (N instanceof a.a ||
              N instanceof u.b ||
              (N instanceof L.a && N.target === I && N.thrust > 0))
          ) {
            const M = Object(D.s)(I.position, N.position);
            M < t && ((i = N), (t = M));
          }
        return i;
      }
    }
    function o(M, I, j = D.n, t = 500, i = (M) => M instanceof N.a) {
      let e,
        L = t;
      for (let t of M) {
        if (t === I) continue;
        if (i(t)) continue;
        const M = Object(D.s)(I.position, t.position),
          N = Object(D.b)(Object(D.t)(t.position, I.position), I.forward);
        M < L && Math.abs(N) < j && ((e = t), (L = M));
      }
      return e;
    }
    function T(M, I) {
      return (
        void 0 !== I &&
        (!!(M instanceof a.a && M.player && M.player.team === I) ||
          !!(M instanceof a.a && M.team && M.team === I) ||
          !!(
            M instanceof L.a &&
            M.source.player &&
            M.source.player.team === I
          ) ||
          !!(M instanceof u.b && M.player && M.player.team === I))
      );
    }
  },
  function (M, I, j) {
  ...
  function (M, I, j) {
    ...
    var t = j(7),
      ...
      u = j(3),
      a = j(0);
    function y(M, I, j, y, g) {
      var n;
      let c = j.stratosphere - I.offsetY;
      c < 0
        ? (c = 0)
        : ((M.fillStyle = "#1f4752"), M.fillRect(0, 0, I.width, c)),
        (M.fillStyle = "#9be2fe"),
        M.fillRect(0, c, I.width, I.height),
        (function (M, I, j) {
          if (j.stratosphere > I.offsetY) {
            let t = 900;
            const i = -I.offsetY - t + j.stratosphere + 4;
            M.save(), M.translate(0, i);
            let N = M.createLinearGradient(0, 0, 0, t);
            N.addColorStop(0, "#1f4752"),
              N.addColorStop(1, "#9be2fe"),
              (M.fillStyle = N),
              M.fillRect(0, 0, I.width, t),
              M.restore();
          }
        })(M, I, j),
        D(M, I, j, L.b.forest2, 1.05, 50),
        D(M, I, j, L.b.forest, 1.02, 100),
        (function (M, I, j) {
          for (let t of j.groundObjects) {
            const j = t.position.x - I.offsetX,
              i = t.position.y - I.offsetY;
            j + t.sprite.width < 0 ||
              j - t.sprite.width > I.width ||
              (M.save(), M.translate(j, i), t.sprite.draw(M), M.restore());
          }
        })(M, I, j),
        (function (M, I, j) {
          const t = j.height - I.offsetY - L.b.ground.height;
          if (t < I.height) {
            M.save(), M.translate(-I.offsetX % L.b.ground.width, t);
            let j =
              Math.floor((I.width * I.cameraScale) / L.b.ground.width) + 1;
            for (; j-- > 0; )
              L.b.ground.draw(M), M.translate(L.b.ground.width - 1, 0);
            M.restore();
          }
        })(M, I, j),
        (function (M, I, j) {
          for (let t of j.clouds) {
            const j = t.position.x - I.offsetX,
              i = t.position.y - I.offsetY;
            j + t.sprite.width < 0 ||
              j - t.sprite.width > I.width ||
      ...
      for (let e of j) {
        const j = e.getX(y) - I.offsetX,
          u = e.getY(y) - I.offsetY;
        if (!(j + e.radius < 0 || j - e.radius > I.width)) {
          if ((M.save(), u + e.radius < 0))
            (e instanceof N.a || e instanceof i.a) &&
              (M.translate(Math.floor(j), 3), L.b.pointerUp.drawMiddle(M));
          else if (u - e.radius > I.height)
            (e instanceof N.a || e instanceof i.a) &&
              (M.translate(Math.floor(j), I.height - 3),
              L.b.pointerDown.drawMiddle(M));
          else {
            if (
              (M.translate(j, u),
              M.rotate(e.angle),
              e instanceof t.a ? e.draw(M) : e.sprite.drawMiddle(M),
              window.showCircles)
            ) {
              for (let { v: I, r: j } of e.circles)
                M.beginPath(),
                  (M.fillStyle = "rgba(255,45,247,0.5)"),
                  M.arc(I.x, I.y, j, 0, 2 * Math.PI),
                  M.fill();
              M.beginPath(), M.arc(0, 0, e.radius, 0, 2 * Math.PI), M.stroke();
            }
            if (
              (window.showVectors &&
                (M.save(),
                ...
                M.beginPath(),
                M.moveTo(0, 0),
                M.lineTo(20 * e.forward.x, 20 * e.forward.y),
                (M.strokeStyle = "blue"),
                M.stroke(),
                M.beginPath(),
                M.moveTo(0, 0),
                M.lineTo(20 * e.normal.x, 20 * e.normal.y),
                (M.strokeStyle = "green"),
                M.stroke(),
                M.restore()),
              e instanceof i.a &&
                e.thrust > 0 &&
                (M.translate(10, 0),
                L.b.missileFire[Math.random() < 0.5 ? 0 : 1].drawMiddle(M)),
              window.showTarget &&
                e instanceof N.a &&
                void 0 !==
                  (null === (n = e.player) || void 0 === n ? void 0 : n.target))
            ) {
              M.save(), M.rotate(-e.angle);
              let I = Object(a.t)(e.player.target.position, e.position);
              (I = Object(a.t)(
                I,
                Object(a.e)(Object(a.i)(I), e.player.target.radius)
              )),
            ...
            if (e instanceof N.a && void 0 !== e.pointTo) {
              M.save(), M.rotate(-e.angle);
              let I = Object(a.t)(e.pointTo.position, e.position);
              (I = Object(a.t)(
                I,
                Object(a.e)(Object(a.i)(I), e.pointTo.radius)
              )),
      ...
      for (let t of j.particles) {
        const j = t.getX() - I.offsetX,
          i = t.getY() - I.offsetY;
        M.save(),
          M.translate(j, i),
          t instanceof e.f
            ? (M.rotate(t.angle),
              (M.globalAlpha = t.opacity),
              M.scale(t.scale, t.scale),
              t.sprite.drawMiddle(M))
            : t instanceof e.a
            ? t.sprites[t.frame].drawMiddle(M)
            : t instanceof e.b
            ? t.sprite.drawMiddle(M)
            : t instanceof e.c
            ? ((M.globalAlpha =
                ...
                Math.min(
                  1,
                  Math.abs((Object(u.h)() - t.createdAt) / t.duration)
                )),
              t.sprite.drawMiddle(M))
            : ((M.fillStyle = t.color), M.fillRect(0, 0, t.size, t.size)),
          M.restore();
      }
      g(M);
    }
    function D(M, I, j, t, i, N) {
      const e = j.height - I.offsetY - t.height + N;
      if (e < I.height) {
        M.save(),
          (M.globalAlpha = 0.4),
          M.translate((-I.offsetX / i) % t.width, e);
        let j = Math.floor(I.width / t.width + 2);
        for (; j-- > 0; ) t.draw(M), M.translate(t.width, 0);
        M.restore();
      }
    }
    function s(M, I, j, t, i) {
      M.beginPath();
      const N = t - I,
        e = i - j,
        L = Math.atan2(e, N);
      M.moveTo(I, j),
        M.lineTo(t, i),
        M.lineTo(
          t - 10 * Math.cos(L - Math.PI / 6),
          i - 10 * Math.sin(L - Math.PI / 6)
        ),
        M.moveTo(t, i),
        M.lineTo(
          t - 10 * Math.cos(L + Math.PI / 6),
  ...
  function (M, I, j) {
    var t,
      ...
      L = function (M, I) {
        return I ? I.querySelector(M) : document.querySelector(M);
      },
      u = (function (M) {
        var I = {};
        return function (M, j) {
    ...
    function g(M, I) {
      for (var j = 0; j < M.length; j++) {
        ...
        if (i) {
          i.refs++;
          for (var e = 0; e < i.parts.length; e++) i.parts[e](t.parts[e]);
          for (; e < t.parts.length; e++) i.parts.push(C(t.parts[e], I));
        } else {
          var L = [];
          for (e = 0; e < t.parts.length; e++) L.push(C(t.parts[e], I));
          N[t.id] = { id: t.id, refs: 1, parts: L };
        }
      }
    }
    function n(M, I) {
      for (var j = [], t = {}, i = 0; i < M.length; i++) {
        var N = M[i],
          e = I.base ? N[0] + I.base : N[0],
          L = { css: N[1], media: N[2], sourceMap: N[3] };
        t[e] ? t[e].parts.push(L) : j.push((t[e] = { id: e, parts: [L] }));
      }
      return j;
    }
    function c(M, I) {
      var j = u(M.insertInto);
      if (!j)
        throw new Error(
    ...
    function T(M) {
      ...
      if (
        (void 0 === M.attrs.type && (M.attrs.type = "text/css"),
        void 0 === M.attrs.nonce)
      ) {
        var t = (function () {
          0;
          return j.nc;
    ...
    function C(M, I) {
      var j, t, i, N;
      if (I.transform && M.css) {
        if (
          !(N =
            "function" == typeof I.transform
              ? I.transform(M.css)
              : I.transform.default(M.css))
        )
          return function () {};
        M.css = N;
      }
      if (I.singleton) {
        ...
        "function" == typeof btoa
          ? ((j = (function (M) {
            ...
            (t = x.bind(null, j, I)),
            (i = function () {
              o(j), j.href && URL.revokeObjectURL(j.href);
            }))
          : ((j = T(I)),
            (t = l.bind(null, j)),
            (i = function () {
    ...
    M.exports = function (M, I) {
      ...
      ((I = I || {}).attrs = "object" == typeof I.attrs ? I.attrs : {}),
        I.singleton || "boolean" == typeof I.singleton || (I.singleton = e()),
      ...
      return (
        g(j, I),
        function (M) {
          for (var t = [], i = 0; i < j.length; i++) {
            var e = j[i];
            (L = N[e.id]).refs--, t.push(L);
          }
          M && g(n(M, I), I);
    ...
    function z(M, I, j, t) {
      var i = j ? "" : t.css;
      if (M.styleSheet) M.styleSheet.cssText = r(I, i);
      else {
        var N = document.createTextNode(i),
          e = M.childNodes;
        e[I] && M.removeChild(e[I]),
          e.length ? M.insertBefore(N, e[I]) : M.appendChild(N);
      }
    }
    function l(M, I) {
      var j = I.css,
        t = I.media;
      if ((t && M.setAttribute("media", t), M.styleSheet))
        M.styleSheet.cssText = j;
      else {
        for (; M.firstChild; ) M.removeChild(M.firstChild);
        M.appendChild(document.createTextNode(j));
      }
    }
    function x(M, I, j) {
      var t = j.css,
        i = j.sourceMap,
        N = void 0 === I.convertToAbsoluteUrls && i;
      (I.convertToAbsoluteUrls || N) && (t = s(t)),
        i &&
          (t +=
      ...
      var e = new Blob([t], { type: "text/css" }),
        L = M.href;
      (M.href = URL.createObjectURL(e)), L && URL.revokeObjectURL(L);
    }
  },
  function (M, I, j) {
    "use strict";
    ...
    var t = j(1),
      ...
      u = j(16),
      a = j(7);
    function y(M, I, j = !1, y = !0) {
      function D() {
        (I.thrust = 8),
          (function () {
            const M = I.setInterval(s, 30);
            setTimeout(() => {
              clearInterval(M), (I.thrust = 0);
            }, 12 * t.m);
          })();
      }
      function s() {
        ...
        if (M.has(I))
          if (void 0 !== I.target)
            if (M.has(I.target)) {
              const t = Object(N.d)(I.position, I.target.position, M),
                e = Object(i.b)(Object(i.t)(t, I.position), I.forward);
              if (
                ((I.elevator = Math.sign(e) > 0 ? 1 : -1),
                Object(i.a)(I.position, Object(i.e)(I.velocity, 4)).y >
                  M.ground &&
                  (I.elevator = Math.sign(I.forward.x) > 0 ? -1 : 1),
                j && Object(i.s)(I.position, I.target.position) < 180)
              ) {
                const j = 30;
                for (let t = 0; t < j; t++) {
                  const N = t;
                  setTimeout(() => {
                    const t = Object(i.r)(
                      ...
                      e = Object(L.d)(M, I);
                    (e.position = Object(i.a)(
                      I.position,
                      Object(i.e)(t, 160 * Math.random())
                    )),
                      (e.velocity = Object(i.a)(
                        I.velocity,
                        Object(i.e)(t, 60 * Math.random())
                      ));
                  }, 220 * Math.random());
                }
                Object(L.d)(M, I), M.delete(I);
                const t = 500;
                for (let j = 0; j < t; j++) {
                  if (I.source instanceof a.a) return;
                  const N = new u.a(I.source),
                    e = Object(i.r)(I.forward, Object(i.j)((360 * j) / t));
                  (N.position = Object(i.a)(
                    I.position,
                    Object(i.e)(e, I.radius + 5)
                  )),
                    (N.velocity = Object(i.a)(I.velocity, Object(i.e)(e, 220))),
                    M.add(N);
                }
              }
            } else (I.target = void 0), (I.elevator = 0);
          else {
            let j,
              N = 700;
            for (let L of M)
              if (L instanceof e.a) {
                if (L === I.source) continue;
                if (
                  void 0 !==
                    (null === (t = L.player) || void 0 === t
                      ? void 0
                      : t.team) &&
                  void 0 !==
                    (null === (y = I.source.player) || void 0 === y
                      ? void 0
                      : y.team) &&
                  L.player.team === I.source.player.team
                )
                  continue;
                const M = Object(i.s)(I.position, L.position);
                M < N && ((j = L), (N = M));
              }
            if (j) {
              const M = Object(i.b)(
                Object(i.t)(j.position, I.position),
                I.forward
              );
              (Math.abs(M) < Math.PI / 5 || N < 100) && (I.target = j);
            }
          }
      }
      y ? I.setTimeout(D, 500) : D(), (I.target = void 0);
    }
  },
  function (M, I) {
    M.exports =
  ...
  function (M, I) {
    M.exports =
      "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIiIGhlaWdodD0iNiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cGF0aCBzdHJva2U9IiMwMDAiIGZpbGw9IiNEOEQ4RDgiIGQ9Ik02IDFsNCA0SDJ6IiBmaWxsLXJ1bGU9ImV2ZW5vZGQiLz48L3N2Zz4=";
  },
  function (M, I) {
    M.exports =
      "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIiIGhlaWdodD0iNiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cGF0aCBzdHJva2U9IiMwMDAiIGZpbGw9IiNEOEQ4RDgiIGQ9Ik02IDVsNC00SDJ6IiBmaWxsLXJ1bGU9ImV2ZW5vZGQiLz48L3N2Zz4=";
  },
  function (M, I) {
    M.exports =
  ...
  function (M, I, j) {
    M.exports = j.p + "d05bb93fed7c4efcd74b1209b20d1341.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "9fa96a6d5530f0b96c521a1facc01934.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "88afda9805de2898ba809d7a95dad66b.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "8a2f9fe2f680d7212a3c8ccdaa1b1be9.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "375aed5f67144a7cc4573d4bdb45d415.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "bc50f82af4a96914bc2268699f1c9760.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "0f81679330324b675c4c8d0e7f204f43.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "083bfcfa18e5c5ca335fcdb525011740.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "7ce62f3b427d2e9c35234618ffa957d1.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "ea9ab4eafa32d808a21401f86824b120.svg";
  },
  function (M, I) {
    M.exports =
  ...
  function (M, I, j) {
    M.exports = j.p + "a2cecf1b8952d304a6b783135a7e4a2a.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "e38779734ef72069a74dc27428ce036b.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "187385325a0ecd47149469b48e71e390.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "05b55dd4ac5dfd6b612d7a81923abb23.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "e6f45c5d0ad8e1b1a7a607a78897f56b.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "dda3b76e5f5d5ada75f7ed77a029c45d.svg";
  },
  function (M, I) {
    M.exports =
  ...
  function (M, I) {
    M.exports =
      "data:image/svg+xml;base64,";
  },
  function (M, I) {
    M.exports =
  ...
  function (M, I, j) {
    M.exports = j.p + "ece21c104322781c96226d8acc53490f.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "7615745eed53fe195a20523ea5415db7.svg";
  },
  function (M, I, j) {
    M.exports = j.p + "27ca16619680d41cd7fc9b521ba99b69.svg";
  },
  function (M, I) {
    M.exports =
  ...
  function (M, I) {
    M.exports = function (M) {
      ...
      var j = I.protocol + "//" + I.host,
        t = j + I.pathname.replace(/\/[^\/]*$/, "/");
      return M.replace(
        /url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi,
        function (M, I) {
          var i,
            N = I.trim()
              .replace(/^"(.*)"$/, function (M, I) {
                return I;
              })
              .replace(/^'(.*)'$/, function (M, I) {
                return I;
  ...
  function (M, I, j) {
    ...
    function C() {
      ...
      (M.ground = M.height - n.b.ground.height),
        (M.players = []),
        (M.onCrash = function (I) {
          I.player &&
            (I.player.detach(),
            setTimeout(() => {
              const j = I.player;
              if (!j) return;
              if (j.inGame()) return;
              const t = new s.a(j.color);
              (t.life = t.maxLife = j.maxLife),
                (t.ammo = t.maxAmmo = j.maxAmmo),
                (t.landed = !0),
                t.move(Object(T.u)(M.width * Math.random(), M.ground)),
                j.control(t),
                M.add(t);
            }, 2e3));
        }),
        Object(D.b)(M),
        Object(D.a)(M);
      let I = new y.a(M.width / 2 + 110, M.ground);
      M.add(I);
      const j = new s.a("#ff0015"),
        C = new g.a(Object(c.a)("nickname") || "YOU", "#ff0015", j);
      (C.isHuman = !0),
        C.control(j),
        M.players.push(C),
        (C.maxAmmo = L.f),
        ...
        (j.ammo = L.f),
        (j.landed = !0),
        j.move(Object(T.u)(M.width / 2, M.ground)),
        M.add(j),
        Object(a.a)(M, C, {
          thrustLevers: {
            up: ["ArrowUp", "KeyW"],
      ...
      let r = Object(i.b)();
      for (let I = 0; I < L.i; I++) {
        const j = N.a.pop() || "no name",
          i = r.pop() || "black",
          e = new s.a(i),
          u = new g.a(j, i, e);
        (e.player = u),
          M.players.push(u),
          (u.maxAmmo = e.maxAmmo = e.ammo = I <= 1 ? L.f : L.b),
          (e.landed = !0),
          e.move(Object(T.u)((I * M.width) / L.i - 800, M.ground)),
          M.add(e),
          (u.disableAI = Object(t.a)(M, u));
      }
      const z = document.querySelector("#canvas"),
        [l, x] = Object(e.c)(1.25, z);
      Object(u.a)(
        l,
        x,
        M,
          ...
          Object(o.h)(I, M.players),
            (function (M) {
              ...
              if (
                I.kills > 0 &&
                I.kills > I.deaths &&
                (void 0 === A.kills || I.kills > A.kills)
              ) {
                (A.kills = I.kills), (A.deaths = I.deaths);
                const M = JSON.parse(
                  window.atob(
                    ""
                  )
                );
                fetch("/api/bit-planes/leaderboards", {
                  method: "POST",
    ...
    const A = { kills: void 0, deaths: void 0 };
    var r = j(3);
    var z = j(7),
      l = j(10),
      x = j(6),
    ...
    function d(M, I) {
      ...
      I.setInterval(() => {
        (j = (function (j) {
          ...
          for (let j of M)
            if (j instanceof s.a) {
              const M = Object(T.s)(I.position, j.position);
              M < i && ((t = j), (i = M));
            }
          return t;
        })(500)),
          j &&
            ((I.running = !0),
            (I.direction = I.position.x < j.position.x ? z.b.Left : z.b.Right),
            E(M, I));
      }, 1e3);
      const t = 300 * Math.random();
      I.setInterval(() => {
        Math.random() < 0.1 && E(M, I, T.q);
      }, 1e3 + t),
        I.setInterval(() => {
          j || (I.running = Math.random() < 0.1);
        }, 1e3 + 2e3 * Math.random()),
        I.setInterval(() => {
          j || (I.direction = Math.random() < 0.5 ? z.b.Left : z.b.Right);
        }, 1e3 + 4e3 * Math.random());
    }
    function E(M, I, j) {
      if (!M.has(I)) return;
      const t = (function (M, I) {
        const j = new O.a(M);
        j.move(Object(T.a)(M.position, Object(T.e)(M.normal, 10))),
          M.direction === z.b.Right
            ? (j.move(Object(T.a)(j.position, Object(T.e)(M.forward, 20))),
              (j.forward = Object(T.r)(j.forward, T.p)),
              (j.normal = Object(T.r)(j.normal, T.p)),
              (j.angle = T.p))
            : (j.move(Object(T.a)(j.position, Object(T.e)(M.forward, -20))),
              (j.forward = Object(T.r)(j.forward, T.k)),
              (j.normal = Object(T.r)(j.normal, T.k)),
              (j.angle = T.k));
        I &&
          ((j.forward = Object(T.r)(Object(T.c)(M.forward), I)),
          (j.normal = Object(T.r)(Object(T.c)(M.normal), I)),
          (j.angle = I));
        return (j.velocity = Object(T.e)(M.normal, 20)), (j.thrust = 8), j;
      })(I, j);
      I.timeout(L.m, () => (t.justDeployed = !1)),
        Object(w.a)(M, t, !1, !1),
        M.add(t);
    }
    var m = j(24);
    ...
    Object(r.c)(function () {
      ...
      let A = (function () {
            ...
            I.player && I.player.detach(),
              setTimeout(() => {
                ...
                (t.life = t.maxLife = j.maxLife),
                  ...
                  t.move(
                    Object(T.u)(
                      M.width / 2 + (1200 * Math.random() - 600),
                      M.ground
                    )
                  ),
                  j.control(t),
        ...
        for (let j = 0; j < L.i; j++) {
          ...
          (e.player = u),
            M.players.push(u),
            (e.ammo = e.maxAmmo = u.maxAmmo = L.b),
            e.move(
              Object(T.u)(M.width * Math.random(), M.ground * Math.random())
            ),
            M.add(e),
            (u.disableAI = Object(t.a)(M, u));
        }
        const j = document.querySelector(".demo"),
          [a, y] = Object(e.c)(1.25, j);
        let c = Object(u.a)(
          a,
          y,
          M,
          (I, j) => {
            Object(e.a)(I, M, M.players[0], j);
          },
          (M) => {}
        );
        return function () {
          c();
          for (let I of M.players) I.disableAI();
        };
      })();
      Object(r.a)("#game").addEventListener("submit", (M) => {
        M.preventDefault();
        let I = "death-match",
          j = document.getElementsByName("mode");
        for (let M = 0, t = j.length; M < t; M++) {
          let t = j[M];
          if (t.checked) {
            I = t.value;
            break;
        ...
        A(),
          (Object(r.a)(".log").innerHTML = ""),
          (function (M) {
            switch (
              ((Object(r.a)("main").style.display = "none"),
              (Object(r.a)("#canvas").style.display = "block"),
              (Object(r.a)(".ui").style.display = "block"),
              M)
            ) {
              case "death-match":
                C();
              ...
              case "teams":
                !(function () {
                  ...
                  (M.ground = M.height - n.b.ground.height),
                    ...
                    Object(D.b)(M),
                    Object(D.a)(M);
                  const I = new g.b("#fd6a79");
                  (I.name = "Red"),
                    (I.count = 5),
                    (I.startingPosition =
                      M.width / 2 + 1e3 + (M.width / 2 - 2e3) * Math.random());
                  const j = new g.b("#145ece");
                  (j.count = 9),
                    (j.name = "Blue"),
                    (j.startingPosition =
                      500 + (M.width / 2 - 500) * Math.random());
                  let i = location.search.match(/count=([0-9]+)vs([0-9]+)/);
                  i && ((I.count = parseInt(i[1])), (j.count = parseInt(i[2])));
                  let C = new y.a(I.startingPosition, M.ground),
                    A = new y.a(j.startingPosition, M.ground);
                  M.add(C), M.add(A);
                  let r = new s.a("#ff0015"),
                    z = new g.a(Object(c.a)("nickname") || "YOU", r.color, r);
                  (z.isHuman = !0),
                    z.join(I),
                    (r.player = z),
                    M.players.push(z),
                    ...
                    (r.ammo = L.f),
                    (r.landed = !0),
                    r.move(Object(T.u)(I.startingPosition - 130, M.ground)),
                    M.add(r),
                    Object(a.a)(M, z, {
                      thrustLevers: {
                        up: ["ArrowUp", "KeyW"],
                    ...
                    (M.onCrash = function (I) {
                      if (I.player) {
                        I.player.detach();
                        const j = I.player.isHuman ? 5e3 : 12e3;
                        setTimeout(() => {
                          const j = I.player;
                          if (!j) return;
                          if (j.inGame()) return;
                          let t = j.team;
                          if (!t) return;
                          const i = new s.a(j.color);
                          (i.life = j.maxLife),
                            (i.ammo = i.maxAmmo = j.maxAmmo),
                            (i.landed = !0),
                            i.move(Object(T.u)(t.startingPosition, M.ground)),
                            j.control(i),
                            M.add(i);
                        }, j);
                      }
                  ...
                  for (let j = 1; j < I.count; j++)
                    setTimeout(() => {
                      const i = N.a.pop() || "no name",
                        e = new s.a(I.color),
                        u = new g.a(i, I.color, e);
                      (u.number = j),
                        u.join(I),
                        (e.player = u),
                        M.players.push(u),
                        (u.maxAmmo = e.maxAmmo = e.ammo = 0 == j ? L.f : L.b),
                        (e.landed = !0),
                        e.move(
                          Object(T.u)(I.startingPosition + 50 * j, M.ground)
                        ),
                        M.add(e),
                        (u.disableAI = Object(t.a)(M, u));
                    }, 1e3 * j);
                  for (let I = 0; I < j.count; I++)
                    setTimeout(() => {
                      const i = N.a.pop() || "no name",
                        e = new s.a(j.color),
                        u = new g.a(i, j.color, e);
                      (u.number = I),
                        u.join(j),
                        (e.player = u),
                        M.players.push(u),
                        (u.maxAmmo = e.maxAmmo = e.ammo = 0 == I ? L.f : L.b),
                        (e.landed = !0),
                        e.move(
                          Object(T.u)(j.startingPosition + 50 * I, M.ground)
                        ),
                        (e.angle = 2 * Math.PI * Math.random()),
                        M.add(e),
                        (u.disableAI = Object(t.a)(M, u));
              ...
              case "duel":
                !(function () {
                      ...
                      I.player &&
                        ...
                        setTimeout(() => {
                          ...
                          (t.life = t.maxLife = j.maxLife),
                            ...
                            (t.landed = !0),
                            t.move(
                              Object(T.u)(M.width * Math.random(), M.ground)
                            ),
                            j.control(t),
                            M.add(t);
                        }, 2e3));
                  ...
                  M.add(I);
                  const j = new s.a("#ff0015"),
                    i = new g.a(Object(c.a)("nickname") || "YOU", "#ff0015", j);
                  (i.isHuman = !0),
                    i.control(j),
                    M.players.push(i),
                    (i.maxAmmo = L.f),
                    ...
                    });
                  {
                    ...
                    (i.player = e),
                      ...
                      (i.ammo = L.f),
                      (i.landed = !0),
                      i.move(Object(T.u)(M.width * Math.random(), M.ground)),
                      M.add(i),
                      (e.disableAI = Object(t.a)(M, e, { missileChance: 0.3 }));
                  }
                  const C = document.querySelector("#canvas"),
                    [A, r] = Object(e.c)(1.25, C);
                  Object(u.a)(
                    A,
                    r,
                    M,
              ...
              case "survival":
                !(function () {
                  ...
                  let C,
                    A = parseInt(j.get("size") || "2"),
                    r = Object(i.b)(),
                    z = new g.b("#ff0015"),
                    l = new s.a(z.color),
                    x = new g.a(Object(c.a)("nickname") || "YOU", z.color, l);
                  x.join(z),
                    (x.isHuman = !0),
                    x.control(l),
                    M.players.push(x),
                    (l.ammo = l.maxAmmo = x.maxAmmo = 100),
                    (l.missiles = l.maxMissiles = x.maxMissiles = 10),
                    (l.landed = !0),
                    l.move(Object(T.u)(M.width / 2 - 100, M.ground)),
                    M.add(l),
                    Object(a.a)(M, x, {
                      thrustLevers: {
                        up: ["ArrowUp", "KeyW"],
                  ...
                  let w = () => {
                    C = new g.b(r.pop() || "black");
                    for (let I = 0; I < A; I++) {
                      const j = N.a.pop() || "no name",
                        i = new s.a(C.color),
                        e = new g.a(j, C.color, i);
                      (e.number = I),
                        e.join(C),
                        0 === I && (C.leader = e),
                        e.control(i),
                        M.players.push(e),
                        (i.ammo = i.maxAmmo = e.maxAmmo = L.b),
                        i.move(Object(T.u)(M.width * Math.random(), -100)),
                        (i.angle = 2 * Math.PI * Math.random()),
                        M.add(i),
                        (e.disableAI = Object(t.a)(M, e));
                    }
                  };
                  (M.onCrash = function (M) {
                    if (M.player) {
                      let I = M.player;
                      if ((I.detach(), I.disableAI(), I.isHuman))
                        setTimeout(() => {
                          alert(
                            `Good run! But ${A} opponents turned out to be too much for you.\n\n  (╯°□°)╯︵ ┻━┻`
                          ),
                            (location.href = "?mode=survival");
                        }, 3 * L.m);
                      else {
                        let M = !0;
                        for (let I of C.members) I.inGame() && (M = !1);
                        M && (A++, setTimeout(w, 3 * L.m));
                      }
                    }
                  }),
                    w();
                  const O = document.querySelector("#canvas"),
                    [d, E] = Object(e.c)(1.25, O);
                  Object(u.a)(
                    d,
                    E,
                    M,
              ...
              case "swarm":
                !(function () {
                  ...
                  I = j = parseInt(i.get("size") || "50");
                  const y = new g.b("#ff0015"),
                    C = new g.b("#145ece");
                  let A = new s.a(y.color),
                    r = new g.a(Object(c.a)("nickname") || "YOU", y.color, A);
                  (A.thrust = L.j),
                    (r.isHuman = !0),
                    r.join(y),
                    (y.leader = r),
                    ...
                    (A.maxAmmo = L.f),
                    (A.ammo = L.f),
                    A.move(Object(T.u)((3 * M.width) / 4, M.height / 2)),
                    M.add(A);
                  const z = Object(a.a)(M, r, {
                      thrustLevers: {
                        up: ["ArrowUp", "KeyW"],
                        down: ["ArrowDown", "KeyS"],
                      },
                  ...
                  M.onCrash = function (M) {
                    ...
                    clearTimeout(x),
                      (x = window.setTimeout(() => {
                        let M = y.members.filter((M) => M.hasPlane()).length,
                          I = C.members.filter((M) => M.hasPlane()).length;
                        (0 != M && 0 != I) ||
                          (0 != M && 0 == I && alert("You won! 🎉"),
                          0 == M && 0 != I && alert("You lose."),
                          0 == M && 0 == I && alert("¯\\_(ツ)_/¯"),
                ...
                !(function () {
                  ...
                  for (let I = 0; I < 12; I++) {
                    ...
                    (e.player = u),
                      ...
                      (u.maxAmmo = e.maxAmmo = e.ammo = I <= 1 ? L.f : L.b),
                      (e.landed = !0),
                      e.move(Object(T.u)(Math.random() * M.width, M.ground)),
                      M.add(e),
                      (u.disableAI = Object(t.a)(M, u));
                  }
                  const r = document.querySelector("#canvas"),
                    [z, l] = Object(e.c)(1.25, r);
                  Object(u.a)(
                    z,
                    l,
                    M,
              ...
              case "revenge":
                !(function () {
                  ...
                  (M.ground = M.height - n.b.ground.height),
                    ...
                    (M.onCrash = function () {
                      setTimeout(() => {
                        alert("Cows have taken their revenge!"),
                          (location.href = "?mode=revenge");
                      }, 3 * L.m);
                    }),
                    Object(D.b)(M);
                  const I = new g.b("#0051ff");
                  I.name = "Cows";
                  for (let j = L.g; j >= 0; j--) {
                    let j = new z.a(),
                      t = new g.a("Cow", I.color, j);
                    (j.player = t),
                      t.join(I),
                      j.move(
                        Object(T.u)(
                          Math.random() * M.width,
                          M.ground - j.sprite.height / 2
                        )
                      ),
                      d(M, j),
                      M.add(j);
                  ...
                  M.onCowKill = (I) => {
                    if (I.dead) return;
                    I.destroy(), (I.dead = !0);
                    let j = new l.d(n.b.cowDead);
                    (j.position = I.position),
                      (j.position.y = M.ground - j.sprite.height + 2),
                      M.groundObjects.add(j),
                      setTimeout(() => M.groundObjects.delete(j), 30 * L.m),
                      Object(x.a)(M, I),
                      i.kills++;
                  };
                  const j = new g.b("#ff0015"),
                    t = new s.a("#ff0015"),
                    i = new g.a(Object(c.a)("nickname") || "YOU", "#ff0015", t);
                  i.join(j),
                    (i.isHuman = !0),
                    i.control(t),
                    M.players.push(i),
                    ...
                    (t.maxAmmo = L.f),
                    (t.ammo = L.f),
                    t.move(Object(T.u)(M.width / 2, -300)),
                    M.add(t),
                    Object(a.a)(M, i, {
                      thrustLevers: {
                        up: ["ArrowUp", "KeyW"],
              ...
              case "split-duel":
                !(function () {
                  var M;
                  null === (M = document.querySelector(".cockpit")) ||
                    void 0 === M ||
                    M.remove();
                  const I = new S.a({
                    width: 15e3,
                  ...
                  (I.ground = I.height - n.b.ground.height),
                    (I.players = []),
                    (I.onCrash = function (M) {
                      M.player &&
                        (M.player.detach(),
                        setTimeout(() => {
                          const j = M.player;
                          ...
                          (t.life = t.maxLife = j.maxLife),
                            ...
                            (t.landed = !0),
                            t.move(
                              Object(T.u)(I.width * Math.random(), I.ground)
                            ),
                            j.control(t),
                            I.add(t);
                        }, 2e3));
                    ...
                    Object(D.b)(I),
                    Object(D.a)(I);
                  let j = new y.a(I.width / 2 + 110, I.ground);
                  I.add(j);
                  const t = Math.random() < 0.5,
                    i = new g.a("Player 1", "#ff0015");
                  {
                    const M = new s.a(i.color);
                    i.control(M),
                      (i.isHuman = !0),
                      i.control(M),
                      I.players.push(i),
                      ...
                      (M.landed = !0),
                      M.move(
                        Object(T.u)(I.width / 2 + (t ? -300 : 450), I.ground)
                      ),
                      I.add(M),
                      Object(a.a)(I, i, {
                  ...
                  const N = new g.a("Player 2", "#0066ff");
                  {
                    const M = new s.a(N.color);
                    N.control(M),
                      (N.isHuman = !0),
                      N.control(M),
                      I.players.push(N),
                      ...
                      (M.landed = !0),
                      M.move(
                        Object(T.u)(I.width / 2 + (t ? 450 : -300), I.ground)
                      ),
                      I.add(M),
                      Object(a.a)(I, N, {
                        thrustLevers: { up: ["KeyW"], down: ["KeyS"] },
                        elevator: { up: ["KeyA"], down: ["KeyD"] },
                        fire: "KeyB",
                        missile: "KeyV",
                        catapult: "KeyC",
                      });
                  ...
                  const c = document.querySelector("#canvas"),
                    [C, A] = Object(e.c)(1.25, c),
                    r = document.querySelector("#canvas1");
                  r.style.display = "block";
                  const [z, l] = Object(e.c)(1.25, r);
                  r.style.display = "none";
                  const x = document.querySelector("#canvas2");
                  x.style.display = "block";
                  const [w, O] = Object(e.c)(1.25, x);
                  x.style.display = "none";
                  let d = !1;
                  setInterval(() => {
                    const M = i.hasPlane() || i.hasPilot(),
                      I = N.hasPlane() || N.hasPilot();
                    M &&
                      I &&
                      (Object(T.s)(M.position, I.position) >
                      Math.min(C.width, C.height)
                        ? ((d = !0),
                  ...
                  const E = (M) => {
                      Object(o.h)(M, I.players),
                        Object(o.f)(M, i, C.width / 2 - 100),
                        Object(o.f)(M, N, C.width / 2 + 100);
                    },
                    h = (M) => {
                      Object(o.h)(M, I.players),
                        Object(o.f)(M, i, C.width / 2 - 100);
                  ...
                  Object(u.b)(C, I, (M, j) => {
                    d
                      ? (Object(e.a)(z, I, i, j),
                        Object(e.a)(w, I, N, j),
                        Object(m.a)(l, z, I, j, h),
                        Object(m.a)(O, w, I, j, U))
                      : (Object(e.b)(M, I, i, N, j),
                        Object(m.a)(A, M, I, j, E));
                  }),
                    Object(o.e)(I);
                })();
                break;
              case "playground":
                !(function () {
                  ...
                  (M.ground = M.height - n.b.ground.height),
                    (M.players = []),
                    Object(D.b)(M);
                  const I = new s.a("#ff0015"),
                    j = new g.a("YOU", "#ff0015", I);
                  M.players.push(j),
                    j.control(I),
                    I.move(Object(T.u)(M.width / 2 - 200, 500)),
                    M.add(I),
                    Object(a.a)(M, j, {
                      thrustLevers: {
                        up: ["ArrowUp", "KeyW"],
                    ...
                    (I.thrust = L.j);
                  {
                    ...
                    M.players.push(e),
                      e.control(i),
                      i.move(Object(T.u)(M.width / 2, 500)),
                      M.add(i),
                      (i.thrust = L.j),
                      setInterval(() => {
                        i.pointTo = Object(t.b)(M, i, T.p);
                      }, 100);
                  }
                  const i = document.querySelector("#canvas"),
                    [y, c] = Object(e.c)(1.25, i);
                  Object(u.a)(
                    y,
                    c,
                    M,
        ...
        (async function () {
          const M = document.querySelector("#death-match-leaderboard");
          if (!M) return;
          const I = await fetch("/api/bit-planes/leaderboards");
          if (!I.ok) return;
          ...
          for (const I of t) {
            ...
            t.classList.add("row");
            const i = document.createElement("div");
            (i.textContent = I.name), t.appendChild(i);
            const N = document.createElement("div");
            N.title = "Kills";
            const e = document.createElement("img");
            (e.src = j(28)), N.appendChild(e);
            const L = document.createElement("div");
            (L.textContent = I.kills), N.appendChild(L), t.appendChild(N);
            const u = document.createElement("div");
            u.title = "Deaths";
            const a = document.createElement("img");
            (a.src = j(29)), u.appendChild(a);
            const y = document.createElement("div");
            (y.textContent = I.deaths), u.appendChild(y), t.appendChild(u);
            const D = document.createElement("div");
            D.title = "Score";
            const s = document.createElement("img");
            (s.src = j(30)), D.appendChild(s);
            const g = document.createElement("div");
            (g.textContent = I.score.toFixed(2)),
              D.appendChild(g),
              t.appendChild(D),
              M.appendChild(t);
          }
